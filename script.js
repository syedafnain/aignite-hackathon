...
//         animateCards(".prize-card"); 
//         animateCards(".why-participate-card");
//         animateCards(".how-participate-card");
//         animateCards(".roadmap-step");
//     }
...
//         window.open("https://forms.gle/TLt6M4whnBisLM4z9", "_blank");
//     };
// });

// function openPsModal(title, description) {
//     let modal = document.getElementById('problemModal');
...
//   const closeBtn = regModal ? regModal.querySelector(".close") : null;
